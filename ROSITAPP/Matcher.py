...
class Replacement:
    def __init__(self, src_groups, src_length, src_inst, rep_insts, file, matcher, markerlist):
        self.src_groups = src_groups
        self.src_length = src_length
        self.src_inst = src_inst
        self.src_lineno = src_inst.get_line_no()
...
class Matcher:
    ...
    def match(self, insts, at_idx, ptmarkers) -> (Replacement, int):
        ...
        if m_list != [] and self._validate(m_list):
            ...
            return (Replacement(m_list, sw, insts[at_idx],
                               insts_list,
                               insts[at_idx].asmfile, self, ptmarkers), prio)
        return (None, -99999)
