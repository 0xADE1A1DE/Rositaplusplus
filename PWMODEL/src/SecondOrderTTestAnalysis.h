...
class second_order_ttest_analysis_t : public analysis_t
{
public:
    struct is_sample_independent {};
    
    second_order_ttest_analysis_t();
    second_order_ttest_analysis_t(const second_order_ttest_analysis_t&);
...
private:
    ...
    PImpl<second_order_ttest_analysis_priv_t> pimpl;
};
