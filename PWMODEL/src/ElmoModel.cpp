...
void elmomodel_t::init(pwmodel_t* pm, const char* execfile)
{
...
void elmomodel_t::finit(pwmodel_t* pm)
{
...
void elmomodel_t::on_first_trace_done(pwmodel_t* pm)
{
}
void elmomodel_t::on_trace_done(pwmodel_t* pm)
{
