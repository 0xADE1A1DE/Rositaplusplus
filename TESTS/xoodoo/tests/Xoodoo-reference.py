...
xp = Xoodoo()
initstate = bytes.fromhex('aff644a1f3be090ada279bf62faaf1eb7d42ec79c3824b393020d515c45ad8e3a0201b664983fc01258f86762adafc98')
inputb = bytes.fromhex('da39a3ee5e6b4b0d3255bfef95601890')
initstate= bytearray(initstate)
for i in range(0, 16):
    initstate[i] = initstate[i] ^ inputb[i]

initstate= bytes(initstate)
print(initstate)
A = State(state=initstate)
A = xp.Permute(A, 12)
print(A)
