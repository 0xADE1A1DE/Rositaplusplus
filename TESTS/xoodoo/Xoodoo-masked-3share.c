...
#define    State2Vars   a00 = state[0+0], a01 = state[0+1], a02 = state[0+2], a03 = state[0+3]; \
                        ...
                        c00 = masks[12+0], c01 = masks[12+1], c02 = masks[12+2], c03 = masks[12+3]; \
                        c10 = masks[16+0], c11 = masks[16+1], c12 = masks[16+2], c13 = masks[16+3]; \
                        c20 = masks[20+0], c21 = masks[20+1], c22 = masks[20+2], c23 = masks[20+3]; \
...
#define Theta()                                             \
                    ...
                    vc1 = c03 ^ c13 ^ c23;                   \
                    vc2 = c00 ^ c10 ^ c20;                   \
                    vc1 = ROTL32(vc1, 5) ^ ROTL32(vc1, 14);    \
                    c00 ^= vc1;                              \
                    c10 ^= vc1;                              \
                    c20 ^= vc1;                              \
                    vc1 = c01 ^ c11 ^ c21;                   \
                    vc2 = ROTL32(vc2, 5) ^ ROTL32(vc2, 14);    \
                    c01 ^= vc2;                              \
                    c11 ^= vc2;                              \
                    c21 ^= vc2;                              \
                    vc2 = c02 ^ c12 ^ c22;                   \
...
void Xoodoo_Permute_12rounds( uint32_t * state, uint32_t *masks)
{
    ...
    a20 ^= b20 ^ c20; a21 ^= b21 ^ c21; a22 ^= b22 ^ c22; a23 ^= b23 ^ c23;
